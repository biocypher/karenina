...
This adapter is wired by TaskEval; users do not normally instantiate it directly. See the [TaskEval skill / docs](../core_concepts/task-eval.md) for the supported workflow.
