...
| I want to... | See |
|--------------|-----|
| Set an API key or path | [Environment Variables](configuration/env-vars.md) |
| Configure answering or parsing models | [ModelConfig](configuration/model-config.md) |
...
| Start the web server | [serve command](cli/serve.md) |
