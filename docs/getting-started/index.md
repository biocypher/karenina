...
**If your goal is evaluating existing outputs** (agent traces, external text) rather than creating benchmarks, skip the Quick Start and go directly to the [TaskEval workflow](../workflows/task-eval/index.md) after installation.
