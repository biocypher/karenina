...
class Answer(BaseAnswer):
    capital: str = Field(
        description=(
            "The capital city named in the response, using the standard English "
            "name (e.g., 'Paris' not 'Ville de Paris'). If multiple cities are "
            "mentioned, extract the one identified as the capital."
        )
    )
