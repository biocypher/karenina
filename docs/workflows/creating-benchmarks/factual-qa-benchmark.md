...
These templates use `VerifiedField` with built-in verification primitives. For cases requiring custom logic, see [Advanced: Custom Verification](../../core_concepts/answer-templates.md).
...
- [Scaled Benchmark Creation](scaled-benchmark-creation.md): Bulk workflows and auto-generation
