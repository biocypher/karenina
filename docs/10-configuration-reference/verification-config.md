...
| Field | Type | Default | Description |
|-------|------|---------|-------------|
| `few_shot_config` | `FewShotConfig \| None` | `None` | Few-shot prompting configuration. Controls example injection into prompts. See [Few-Shot Configuration](../04-core-concepts/few-shot.md). |
