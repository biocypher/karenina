...
**[Checkpoints](checkpoints.md)** → **[Answer Templates](answer-templates.md)** → **[Rubrics](rubrics/index.md)** → **[Evaluation Modes](evaluation-modes.md)** → **[Adapters](adapters.md)**
...
- Designing evaluation criteria? Start with [Answer Templates](answer-templates.md) and [Rubrics](rubrics/index.md)
- Choosing an LLM backend? See [Adapters](adapters.md)
- Adding tool use to evaluation? See [MCP Overview](mcp-overview.md)
- Classifying questions by difficulty? See [Adele](adele.md)
- Improving parsing accuracy? See [Few-Shot](few-shot.md)
