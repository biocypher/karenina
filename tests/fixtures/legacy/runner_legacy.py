...
def run_single_model_verification(
    ...
    # Initialize usage_metadata and agent_metrics
...
{raw_llm_response}
        ...
        try:
            ...
            if abstention_enabled:
                ...
                abstention_detected, abstention_check_performed, abstention_reasoning, usage_metadata = (
                    detect_abstention(
                        raw_llm_response=raw_llm_response,
                        parsing_model=parsing_model,
                        question_text=question_text,
        ...
        return VerificationResult(
            ...
            rubric=VerificationResultRubric(
                rubric_evaluation_performed=rubric_result is not None,
