"""Tests that export_verification_results_json emits arrays for multi-model sweeps.
...
class TestExportHeaderMultiModel:
    def test_single_model_run_emits_single_element_arrays(self) -> None:
    ...
    def test_multi_model_sweep_emits_full_arrays(self) -> None:
    ...
    def test_job_duration_is_emitted_when_both_times_present(self) -> None:
