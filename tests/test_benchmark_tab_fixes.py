...
def additional_verification_results() -> None:
    ...
    return {
        "q3": {
            ...
            "parsed_gt_response": {"expected_answer": "A programming language"},
            "parsed_llm_response": {"answer": "A programming language"},
            "verify_result": True,
            "answering_model": "gpt-4",
            "parsing_model": "gpt-4",
            "execution_time": 2.0,
    ...
    def test_results_overwrite_same_question_id(self, mock_verification_results) -> None:
        ...
        new_result = {
            "q1": {
                ...
                "parsed_gt_response": {"expected_answer": "5"},
                "parsed_llm_response": {"answer": "5"},
                "verify_result": False,
