...
class JudgmentResults(BaseModel):
    ...
    def __init__(self, results: list[VerificationResult], **data: Any) -> None:
        ...
        self._dataframe_builder: JudgmentDataFrameBuilder | None = None

    @property
    def dataframe_builder(self) -> JudgmentDataFrameBuilder:
        """
        Get the DataFrame builder for this results instance.

        Returns:
            JudgmentDataFrameBuilder instance for converting results to DataFrames
        """
        if self._dataframe_builder is None:
            self._dataframe_builder = JudgmentDataFrameBuilder(self.results)
    ...
    def to_dataframe(self) -> Any:
        ...
        """
        return self.dataframe_builder.build_dataframe()
