...
# ============================================================================
# LEGACY IMPLEMENTATION (Kept for regression testing)
# ============================================================================
# The following is the original monolithic implementation, preserved for
# reference and regression testing during the migration to stage-based pipeline.
# This code will be removed once regression tests pass 100%.
# ============================================================================


def run_single_model_verification_LEGACY(
    question_id: str,
    question_text: str,
    template_code: str,
    answering_model: ModelConfig,
