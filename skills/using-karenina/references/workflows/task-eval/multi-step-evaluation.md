...
- [Basic Evaluation](basic-evaluation.md): Single-step evaluation with templates and rubrics
- [Quality Assessment](quality-assessment.md): Rubric-only evaluation with all trait types
